...
export default async function GlobalExtraWorkPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Global Extra Work Log</h1>
        <p className="text-muted-foreground mt-1">Review and manage all out-of-scope deviations across all projects.</p>
      </div>
