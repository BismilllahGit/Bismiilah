    ...
    <div className="p-4 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <Card className="bg-slate-100 border-slate-300">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-800">Closed Projects</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-slate-600">{closedCount}</div>
          </CardContent>
        </Card>
      </div>
      ...
      {projects.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed rounded-lg bg-slate-50">
          ...
          <p className="text-muted-foreground mt-2 mb-6">You haven't created any projects yet.</p>
          <Link href="/projects/new">
